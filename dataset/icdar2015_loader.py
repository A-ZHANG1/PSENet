...
funs_root_dir = '../OCR_dataset/funsdata/training_data/'
funs_train_data_dir = funs_root_dir + 'images/'
funs_train_gt_dir = funs_root_dir + 'wordtxts/'
mlt_root_dir = '../OCR_dataset/mlt/'
mlt_train_data_dir = mlt_root_dir + 'image/'
mlt_train_gt_dir = mlt_root_dir + 'label8/'
sr19_root_dir = '../OCR_dataset/SROIE2019/task1train/'
sr19_train_data_dir = sr19_root_dir + 'img/'
sr19_train_gt_dir = sr19_root_dir + 'txt/'
ic15_root_dir = '../OCR_dataset/ICDAR_2015/'
ic15_train_data_dir = ic15_root_dir + 'train_img/'
ic15_train_gt_dir = ic15_root_dir + 'train_gt/'
# ic15_test_data_dir = ic15_root_dir + 'test_img/'
